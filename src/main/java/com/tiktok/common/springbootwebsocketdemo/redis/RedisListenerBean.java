package com.tiktok.common.springbootwebsocketdemo.redis;
...
public class RedisListenerBean {
    ...
    /**
     * redis消息监听器容器-监听msgToAll、userStatus
    ...
    RedisMessageListenerContainer container(RedisConnectionFactory connectionFactory, MessageListenerAdapter listenerAdapter) {
        // 创建一个 RedisMessageListenerContainer 对象
        RedisMessageListenerContainer container = new RedisMessageListenerContainer();
        // 设置 RedisMessageListenerContainer 的连接工厂
        container.setConnectionFactory(connectionFactory);

        // 监听msgToAll、userStatus
