...
public class StationMessageService {
    ...
    public List<StationMessage> findLetters(String conversationId, int offset, int limit) {
    ...
    public StationMessage findLatestNotice(int userId, String topic) {
    ...
    public List<StationMessage> findNotices(int userId, String topic, int offset, int limit) {
